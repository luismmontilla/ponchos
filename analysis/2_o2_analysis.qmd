...
x \frac{mg}{L}O_2 \cdot \text{Volume measured} (L) \cdot \frac{1}{time (h)}  \cdot \frac{1g}{1000 mgO_2} O_2 \cdot \frac{mol}{31.99 g}O_2 \cdot \frac{1000000 \mu mol}{mol} = y\frac{\mu mol}{h}O_2 \\
...
```{r}
ponchos_data |> 
  filter(replicate != "B" & Observation == "Chondrilla") |> 
    filter(!(O2_rate > 0 & light == 0)) |>
  group_by(Month, light, Observation) |> 
